...
#define HS_LIDAR_QT_BLOCK_SIZE                                                 \
  (HS_LIDAR_QT_UNIT_SIZE * HS_LIDAR_QT_UNIT_NUM +                              \
   HS_LIDAR_QT_BLOCK_HEADER_AZIMUTH)
#define HS_LIDAR_QT_BODY_SIZE                                                  \
  (HS_LIDAR_QT_BLOCK_SIZE * HS_LIDAR_QT_BLOCK_NUMBER)
// Tail
...
#define HS_LIDAR_QT_PACKET_WITHOUT_UDPSEQ_SIZE                                 \
  (HS_LIDAR_QT_HEAD_SIZE + HS_LIDAR_QT_BODY_SIZE +                             \
   HS_LIDAR_QT_PACKET_TAIL_WITHOUT_UDPSEQ_SIZE)
...
const float pandarQT_elev_angle_map[] = {
    -52.121f, -49.785f, -47.577f, -45.477f, -43.465f, -41.528f, -39.653f,
    -37.831f, -36.055f, -34.320f, -32.619f, -30.950f, -29.308f, -27.690f,
    -26.094f, -24.517f, -22.964f, -21.420f, -19.889f, -18.372f, -16.865f,
    -15.368f, -13.880f, -12.399f, -10.925f, -9.457f,  -7.994f,  -6.535f,
    -5.079f,  -3.626f,  -2.175f,  -0.725f,  0.725f,   2.175f,   3.626f,
    5.079f,   6.534f,   7.993f,   9.456f,   10.923f,  12.397f,  13.877f,
    15.365f,  16.861f,  18.368f,  19.885f,  21.415f,  22.959f,  24.524f,
    26.101f,  27.697f,  29.315f,  30.957f,  32.627f,  34.328f,  36.064f,
    37.840f,  39.662f,  41.537f,  43.475f,  45.487f,  47.587f,  49.795f,
    52.133f};
