...
#define HS_LIDAR_XT_BLOCK_SIZE                                                 \
  (HS_LIDAR_XT_UNIT_SIZE * HS_LIDAR_XT_UNIT_NUM +                              \
   HS_LIDAR_XT_BLOCK_HEADER_AZIMUTH)
#define HS_LIDAR_XT_BODY_SIZE                                                  \
  (HS_LIDAR_XT_BLOCK_SIZE * HS_LIDAR_XT_BLOCK_NUMBER)
// Tail
...
const float blockXTOffsetDual[HS_LIDAR_XT_BLOCK_NUMBER] = {
    5.632f - 50.0f * 3.0f, 5.632f - 50.0f * 3.0f, 5.632f - 50.0f * 2.0f,
    5.632f - 50.0f * 2.0f, 5.632f - 50.0f * 1.0f, 5.632f - 50.0f * 1.0f,
    5.632f - 50.0f * 0.0f, 5.632f - 50.0f * 0.0f};
const float blockXTOffsetSingle[HS_LIDAR_XT_BLOCK_NUMBER] = {
    5.632f - 50.0f * 7.0f, 5.632f - 50.0f * 6.0f, 5.632f - 50.0f * 5.0f,
    5.632f - 50.0f * 4.0f, 5.632f - 50.0f * 3.0f, 5.632f - 50.0f * 2.0f,
    5.632f - 50.0f * 1.0f, 5.632f - 50.0f * 0.0f};

const float laserXTOffset[HS_LIDAR_XT_UNIT_NUM] = {
    1.512f * 0.0f + 0.368f,  1.512f * 1.0f + 0.368f,  1.512f * 2.0f + 0.368f,
    1.512f * 3.0f + 0.368f,  1.512f * 4.0f + 0.368f,  1.512f * 5.0f + 0.368f,
    1.512f * 6.0f + 0.368f,  1.512f * 7.0f + 0.368f,

    1.512f * 8.0f + 0.368f,  1.512f * 9.0f + 0.368f,  1.512f * 10.0f + 0.368f,
    1.512f * 11.0f + 0.368f, 1.512f * 12.0f + 0.368f, 1.512f * 13.0f + 0.368f,
    1.512f * 14.0f + 0.368f, 1.512f * 15.0f + 0.368f,

    1.512f * 16.0f + 0.368f, 1.512f * 17.0f + 0.368f, 1.512f * 18.0f + 0.368f,
    1.512f * 19.0f + 0.368f, 1.512f * 20.0f + 0.368f, 1.512f * 21.0f + 0.368f,
    1.512f * 22.0f + 0.368f, 1.512f * 23.0f + 0.368f,

    1.512f * 24.0f + 0.368f, 1.512f * 25.0f + 0.368f, 1.512f * 26.0f + 0.368f,
    1.512f * 27.0f + 0.368f, 1.512f * 28.0f + 0.368f, 1.512f * 29.0f + 0.368f,
    1.512f * 30.0f + 0.368f, 1.512f * 31.0f + 0.368f};
...
const float blockXTMOffsetTriple[HS_LIDAR_XT_BLOCK_NUMBER] = {
    5.632f - 50.0f * 1.0f, 5.632f - 50.0f * 1.0f, 5.632f - 50.0f * 1.0f,
    5.632f - 50.0f * 0.0f, 5.632f - 50.0f * 0.0f, 5.632f - 50.0f * 0.0f,
    5.632f - 50.0f * 0.0f, 5.632f - 50.0f * 0.0f};

const float blockXTMOffsetDual[HS_LIDAR_XT_BLOCK_NUMBER] = {
    5.632f - 50.0f * 2.0f, 5.632f - 50.0f * 2.0f, 5.632f - 50.0f * 1.0f,
    5.632f - 50.0f * 1.0f, 5.632f - 50.0f * 0.0f, 5.632f - 50.0f * 0.0f,
    5.632f - 50.0f * 0.0f, 5.632f - 50.0f * 0.0f};
const float blockXTMOffsetSingle[HS_LIDAR_XT_BLOCK_NUMBER] = {
    5.632f - 50.0f * 5.0f, 5.632f - 50.0f * 4.0f, 5.632f - 50.0f * 3.0f,
    5.632f - 50.0f * 2.0f, 5.632f - 50.0f * 1.0f, 5.632f - 50.0f * 0.0f,
    5.632f - 50.0f * 0.0f, 5.632f - 50.0f * 0.0f};
